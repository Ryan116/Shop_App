...
class MainScreenTypeConverters {
    ...
    private val moshiBestSellerDB = Moshi.Builder().add(com.squareup.moshi.kotlin.reflect.KotlinJsonAdapterFactory()).build()
    ...
    private val moshiHomeStoreDB = Moshi.Builder().add(com.squareup.moshi.kotlin.reflect.KotlinJsonAdapterFactory()).build()
